      ...
      <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
        <div className="sm:flex sm:items-center sm:justify-between">
          ...
          <div className="mt-4 flex flex-col max-md:flex-row gap-4 sm:mt-0 sm:flex-row sm:items-center">
            ...
            <Link to="/contact">
            <button
              className={`inline-flex items-center justify-center gap-1.5 rounded-lg ${location.pathname === '/contact' ? 'bg-slate-400' : 'bg-indigo-500' } px-4 py-2 text-sm font-medium text-white transition hover:bg-indigo-400 focus:outline-none focus:ring`}
              type="button">
              <MdWork/> Contact Me
            </button>
            </Link>
